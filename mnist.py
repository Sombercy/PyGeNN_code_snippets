...
model.add_synapse_population("pn_kc", "SPARSE_GLOBALG", NO_DELAY,
    pn, kc,
    "StaticPulse", {}, {"g": PN_KC_WEIGHT}, {}, {},
    "ExpCurr", {"tau": PN_KC_TAU_SYN}, {},
    init_connectivity("FixedProbabilityNoAutapse", {"prob": PN_KC_SPARSITY}))

model.add_synapse_population("kc_ggn", "DENSE_GLOBALG", NO_DELAY,
                             kc, ggn,
                             "StaticPulse", {}, {"g": KC_GGN_WEIGHT}, {}, {},
                             "ExpCurr", {"tau": KC_GGN_TAU_SYN}, {})

model.add_synapse_population("ggn_kc", "DENSE_GLOBALG", NO_DELAY,
                             ggn, kc,
                             graded_synapse_model, GGN_KC_PARAMS, {"g": GGN_KC_WEIGHT}, {}, {},
                             "ExpCurr", {"tau": GGN_KC_TAU_SYN}, {})

kc_mbon = model.add_synapse_population("kc_mbon", "DENSE_INDIVIDUALG", NO_DELAY,
                                       kc, mbon,
                                       symmetric_stdp, KC_MBON_PARAMS, {"g": init_var("Uniform", KC_MBON_WEIGHT)}, {}, {},
                                       "ExpCurr", {"tau": KC_MBON_TAU_SYN}, {})

model.add_synapse_population("mbon_mbon", "DENSE_INDIVIDUALG", NO_DELAY,
                             mbon, mbon,
                             "StaticPulse", {}, {"g": init_var(lateral_inhibition, {"g": MBON_MBON_WEIGHT})}, {}, {},
...
while model.timestep < (single_example_timesteps * NUM_STIM):
    ...
    #  print(example,timestep_in_example, np.bincount(mbon.current_spikes, minlength=NUM_MBON))
